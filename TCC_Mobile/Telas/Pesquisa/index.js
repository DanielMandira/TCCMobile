    ...
    <View style={styles.container}>
      <SafeAreaView>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate(Home)}>
          ...
          <TouchableOpacity>
            <Ionicons name='search-circle-outline'size={30} color="#783560"  style={{margin:5}}></Ionicons>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
      ...
      <ScrollView>  
        ...
        <Text numberOfLines={line2} onPress={()=>{if(setLine2){
          ...
          <Text numberOfLines={line3} onPress={()=>{if(setLine3){
            if(line3==1){
              setLine3(null)
            }
            else{
        ...
        <TouchableOpacity style={styles.botao} onPress={()=>{if(setModalVisible){
